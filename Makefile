...
cleanup-test-e2e: ## Tear down the k3d cluster used for e2e tests
	@$(K3D) delete cluster --name $(K3D_CLUSTER)
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name policy-manager-builder
	$(CONTAINER_TOOL) buildx use policy-manager-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm policy-manager-builder
	rm Dockerfile.cross
