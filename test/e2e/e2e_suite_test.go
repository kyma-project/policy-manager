...
var (
	...
	projectImage = "example.com/policy-manager:v0.0.1"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting policy-manager integration test suite\n")
...
var _ = BeforeSuite(func() {
	...
	// TODO(user): If you want to change the e2e test vendor from k3d, ensure the image is
